...
Write-Host "  IntentWatch Setup" -ForegroundColor Cyan
Write-Host "=====================================" -ForegroundColor Cyan
Write-Host ""
...
try {
    ...
    if ($nodeVersionNum -lt 16) {
        Write-Host "  ⚠ Warning: Node.js 16 or higher is recommended" -ForegroundColor Yellow
    }
} catch {
...
Write-Host "     .\start-intentwatch.ps1" -ForegroundColor Yellow
Write-Host ""
Write-Host "  2. Or start components separately:" -ForegroundColor White
